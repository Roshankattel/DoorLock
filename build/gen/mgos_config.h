 ...
 * Command: /data/fwbuild-volumes/2.14.0/apps/doorlock/esp8266/build_contexts/build_ctx_466103630/deps/modules/mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.14.0/apps/doorlock/esp8266/build_contexts/build_ctx_466103630/build/gen/ /data/fwbuild-volumes/2.14.0/apps/doorlock/esp8266/build_contexts/build_ctx_466103630/deps/modules/mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.14.0/apps/doorlock/esp8266/build_contexts/build_ctx_466103630/build/gen/mos_conf_schema.yml
 */
...
static inline int mgos_sys_config_get_hardware_relayPin(void) { return mgos_config_get_hardware_relayPin(&mgos_sys_config); }
void mgos_config_set_hardware_relayPin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_hardware_relayPin(int v) { mgos_config_set_hardware_relayPin(&mgos_sys_config, v); }
...
static inline int mgos_sys_config_get_hardware_pulseTm(void) { return mgos_config_get_hardware_pulseTm(&mgos_sys_config); }
void mgos_config_set_hardware_pulseTm(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_hardware_pulseTm(int v) { mgos_config_set_hardware_pulseTm(&mgos_sys_config, v); }
...
static inline int mgos_sys_config_get_hardware_relayStat(void) { return mgos_config_get_hardware_relayStat(&mgos_sys_config); }
void mgos_config_set_hardware_relayStat(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_hardware_relayStat(int v) { mgos_config_set_hardware_relayStat(&mgos_sys_config, v); }
